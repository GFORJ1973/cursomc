...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "16256152612",TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("312321312","1231231213"));
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "32321321", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "32321321", cli1, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("30/10/2018 10:32"), cli1, e2);
